...
const placementMigration_1 = require("./lib/utils/placementMigration");
...
console.log('needsMigration(list):', (0, placementMigration_1.needsMigration)([existing, fresh]));
const migrated = (0, placementMigration_1.migratePlacementCompanies)([existing, fresh]);
...
const again = (0, placementMigration_1.migratePlacementCompanies)([existing, fresh]);
...
const fresh2 = { id: (0, storage_1.generateId)(), ...aiPayload, name: 'Zomato', schedule: [] };
const two = (0, placementMigration_1.migratePlacementCompanies)([existing, fresh, fresh2]);
