...
export const SEED_PROJECTS: Project[] = [
  {
    ...
    link: 'https://github.com/user/northbound-ai',
    githubLink: 'https://github.com/user/northbound-ai',
    liveDemo: 'https://northbound-ai.vercel.app',
